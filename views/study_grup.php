        ...
        <main class="mx-auto max-w-[430px] lg:max-w-screen-xl w-full flex-grow px-4 pt-5 pb-16">
            <div class="create-group-button py-2 lg:px-3">
                <a href="/edumate/buat-grup"
                    class="block w-full h-[40px] rounded-lg bg-edumate-base text-edumate-white shadow-md font-semibold flex items-center justify-center
            ...
            <div class="searchbar py-4 flex items-center lg:px-3 lg:py-8">
                <input type="text"
                    class="search w-full max-w-[289px] h-[40px] rounded-lg bg-edumate-base px-4 py-2 mr-2 border-none font-bold text-edumate-white placeholder:text-edumate-white/70 focus:outline-none focus:ring-2 focus:ring-blue-500 lg:max-w-[calc(100%-120px)] lg:h-[50px] lg:text-lg"
                    placeholder="Cari grup">
                <img src="image/search.png"
                    class="search-icon w-[37px] h-[37px] bg-edumate-base rounded-lg p-2 cursor-pointer lg:w-[45px] lg:h-[45px] lg:p-2 hover:scale-110 transition-transform duration-200"
                    alt="Search Icon">
            ...
            <section class="mb-6 lg:px-3">
                ...
                <div
                    ...
                    <a href="#"
                        class="bg-edumate-white border border-edumate-gray rounded-full px-3 py-1.5 text-xs shadow-sm text-edumate-black font-normal hover:bg-edumate-base hover:text-edumate-white transition-colors duration-200 lg:text-sm">
                        Lihat Grup
                    </a>
                </div>
            </section>
            ...
            <section class="lg:px-3">
                ...
                <div
                    ...
                    <a href="#"
                        class="bg-edumate-base text-edumate-white rounded-full px-3 py-1.5 text-xs shadow-sm font-normal hover:bg-edumate-gray hover:text-edumate-black transition-colors duration-200 lg:text-sm">
                        Gabung Grup
                    </a>
                </div>
