...
<head>
    ...
    <title>Request Mentor | EduMate</title> <script src="https://cdn.tailwindcss.com"></script>
    <script>
        tailwind.config = {
            theme: {
                extend: {
...
<body class="bg-edumate-white font-poppins text-edumate-black">
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-grow mx-auto max-w-md w-full px-4 py-8 lg:max-w-screen-xl flex flex-col items-center">
            <div class="title flex justify-center items-center pt-2 pb-6 text-edumate-black">
                <img src="image/mentor.png" class="w-[30px] h-[30px] mr-2 lg:w-[40px] lg:h-[40px] lg:mr-3"
                    alt="Mentor Icon">
                <h1 class="text-2xl font-bold lg:text-3xl">Request Mentor Baru</h1>
            </div>

            <form action="/edumate/become-mentor" method="POST"
                class="form-request w-[333px] bg-edumate-black rounded-[55px] mx-auto mb-12 px-7 pt-10 pb-10 lg:w-[450px] lg:px-10 lg:pt-12 lg:pb-12 shadow-lg">
                <div class="mb-4">
                ...
                <div class="mb-6">
                    <label for="target"
                        class="text-edumate-white text-base font-bold pl-2 mb-1 block lg:text-lg">Target Belajar</label>
                ...
                <button type="submit"
                    class="block w-[152px] h-[47px] bg-edumate-white rounded-3xl mx-auto flex justify-center items-center font-bold text-lg text-edumate-black hover:bg-edumate-gray transition-colors duration-200 lg:w-[200px] lg:h-[55px] lg:text-xl">
                    UNGGAH
                </button>
            </form>
        </main>
        ...
        <div
            class="bottom-navbar w-full h-[92px] bg-edumate-black p-2 flex justify-center items-center rounded-full mt-auto lg:hidden fixed bottom-0 left-0 right-0 z-50">
